    ...
    implements org.ligi.ufo.DUBwiseDefinitions,DUBwiseUIDefinitions,org.ligi.ufo.DUBwiseLangDefs
{
    ...
    public boolean do_current_voice;
...
//#endif
    ...
    // Bit1 Flighttime Voice
    // Bit2 Satelites Voice
    // Bit3 Current Voice
...
//#endif
	...
	// sound
	{STRINGID_SOUND,STRINGID_ALTIMETER,STRINGID_ALTSTEPS,STRINGID_VOLUME},

	// voice
	{STRINGID_MINIMAL,STRINGID_VOICE_NOPOINT,STRINGID_INTRO,STRINGID_DELAYINS,STRINGID_VOLTS,STRINGID_ALTITUDE,STRINGID_SATELITES,STRINGID_FLIGHTTIME,STRINGID_CURRENT}, 
    ...
    public int[][] _choice_stringids={ {STRINGID_LANG0,STRINGID_LANG1,STRINGID_LANG2,STRINGID_LANG3}, /* FIXME - make dynamic */{ STRINGID_DARK,STRINGID_LIGHT } , {STRINGID_KMH,STRINGID_MPH,STRINGID_CMS},{STRINGID_DECIMAL,STRINGID_MINSEC} } ;
...
//#endif
	...
	{SETTINGS_POS_BITFIELD3*8+7,SETTINGS_POS_BITFIELD3*8+6,SETTINGS_POS_BITFIELD3*8+5,SETTINGS_POS_VOICEDELAY,SETTINGS_POS_BITFIELD2*8+0, SETTINGS_POS_BITFIELD3*8+4 , SETTINGS_POS_BITFIELD4*8+0, SETTINGS_POS_BITFIELD4*8+1, SETTINGS_POS_BITFIELD4*8+2   }, //voice
...
//#endif
	 ,PARAMTYPE_BITSWITCH
				  ...
				  {PARAMTYPE_BITSWITCH,PARAMTYPE_BITSWITCH,PARAMTYPE_BITSWITCH,PARAMTYPE_BYTE,PARAMTYPE_BITSWITCH,PARAMTYPE_BITSWITCH,PARAMTYPE_BITSWITCH,PARAMTYPE_BITSWITCH,PARAMTYPE_BITSWITCH} , // voice
