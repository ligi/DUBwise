...
//#endif
    ...
    public final static int SETTINGS_FIELD_LENGTH       =25;
...
//#endif
		...
		minimal_voice=((val&64)!=0);
		voice_nopoint=((val&128)!=0);
...
//#endif
	...
	*/
    ...
    public int[] plain_defaults={0,0,0,0,42,42,42,1,1,-4242,-4242,-4242,0,10,0,0,7,0,7,0,10,30,1000,-4242,10};
    public int[] fancy_defaults={0,255,0,0,42,42,42,1,1,-4242,-4242,-4242,150,10,5,0,7,1,10,0,1,3,100,-4242,10};
...
//#endif
	...
	{STRINGID_BACKTOMAINMENU,STRINGID_FULLSCREEN,STRINGID_CLEAR,STRINGID_PARAMSAVE },
	...
	{STRINGID_MINIMAL,STRINGID_VOICE_NOPOINT,STRINGID_INTRO,STRINGID_DELAYINS,STRINGID_VOLTS,STRINGID_ALTITUDE}, // voice
...
//#endif
...
} , {2,3} , {4,5,6,7,8} , {SETTINGS_POS_KEY_BACK,SETTINGS_POS_KEY_FULL,SETTINGS_POS_KEY_CLEAR,SETTINGS_POS_KEY_PARAMSAVE},{SETTINGS_POS_BITFIELD1*8 +6,SETTINGS_POS_BITFIELD1*8 +7, SETTINGS_POS_GRAPHINTERVAL} ,
	...
	{SETTINGS_POS_BITFIELD3*8+7,SETTINGS_POS_BITFIELD3*8+6,SETTINGS_POS_BITFIELD3*8+5,SETTINGS_POS_VOICEDELAY,SETTINGS_POS_BITFIELD2*8+0, SETTINGS_POS_BITFIELD3*8+4 }, 
...
//#endif
	 ,PARAMTYPE_BITSWITCH
} , {PARAMTYPE_CHOICE+2,PARAMTYPE_CHOICE+3} , {PARAMTYPE_BYTE,PARAMTYPE_BYTE,PARAMTYPE_BYTE,PARAMTYPE_BYTE,PARAMTYPE_BYTE}, {PARAMTYPE_KEY,PARAMTYPE_KEY,PARAMTYPE_KEY,PARAMTYPE_KEY } , {PARAMTYPE_BITSWITCH,PARAMTYPE_BITSWITCH,PARAMTYPE_BYTE}, 
				  {PARAMTYPE_BITSWITCH,PARAMTYPE_BITSWITCH,PARAMTYPE_BYTE,PARAMTYPE_BYTE} , //sound
				  {PARAMTYPE_BITSWITCH,PARAMTYPE_BITSWITCH,PARAMTYPE_BITSWITCH,PARAMTYPE_BYTE,PARAMTYPE_BITSWITCH,PARAMTYPE_BITSWITCH} , // voice
